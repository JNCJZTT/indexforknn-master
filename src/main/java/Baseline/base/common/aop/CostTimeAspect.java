package Baseline.base.common.aop;

import Baseline.base.domain.annotation.CostTime;
...
public class CostTimeAspect {
     ...
     * 首先定义一个切点
     */
    @org.aspectj.lang.annotation.Pointcut("@annotation(Baseline.base.domain.annotation.CostTime)")
